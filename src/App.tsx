    ...
    <div className="relative w-full min-h-screen bg-black overflow-x-hidden">
      ...
      {!loading && (
        <>
          ...
          <div id="themes" className="scroll-mt-24 sm:scroll-mt-28">
            <Themes />
          </div>

          <div id="prizes" className="scroll-mt-24 sm:scroll-mt-28">
            <Prizes />
          </div>

          <div id="timeline" className="scroll-mt-24 sm:scroll-mt-28">
            <Timeline />
          </div>

          <div id="gallery" className="scroll-mt-24 sm:scroll-mt-28">
            <Gallery />
          </div>

          <div id="faqs" className="scroll-mt-24 sm:scroll-mt-28">
            <FAQ />
          </div>
